									...
									<table style="width: 80%; margin: 0px auto;">
										<tr>
											<!-- <td><div class="control-group">
													...
													<div class="controls">
														<span class="input-xlarge uneditable-input">单号自动生成</span>
													</div>
												</div></td> -->
											<td><div class="control-group">
										...
										<tr>
											...
											<td><div class="control-group">
													<label class="control-label" for="supplier.supplierId">报损仓库&nbsp;&nbsp;</label>
													<div class="controls">
										...
										<tr>
											<td colspan="2">
												<div class="control-group">
													<label class="control-label" for="supplier.supplierId">报损理由&nbsp;&nbsp;</label>
													<div class="controls">
														<!-- <input type="text" style="width: 500px;"
															 id="requestTime" name="requestTime"														
															placeholder="请输入报损理由" /> -->
															<textarea cols="15" rows="5" id="damagedReason" name="damagedReason" placeholder="请输入报损理由"></textarea>
													</div>
												</div>
											</td>
										</tr>
										<tr>
											<td colspan="2">
												<div class="control-group">
													<label class="control-label" for="supplier.supplierId">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注</label>
													<div class="controls">
														<!-- <input type="text" 
															 id="requestTime" name="requestTime"														
															placeholder="备注" /> -->
															<textarea cols="15" rows="5" id="remark" name="remark" placeholder="备注"></textarea>
													</div>
												</div>
											</td>
										</tr>
